...
add wave -noupdate -expand -group DP0 -group PC0 /system_tb/DUT/CPU/DP0/PC/pcif/pcout
add wave -noupdate -expand -group DP0 -group PC0 /system_tb/DUT/CPU/DP0/PC/CLK
add wave -noupdate -expand -group DP0 -group PC0 /system_tb/DUT/CPU/DP0/PC/nRST
add wave -noupdate -expand -group DP0 -group PC0 /system_tb/DUT/CPU/DP0/PC/PCplus4
add wave -noupdate -expand -group DP0 -group PC0 /system_tb/DUT/CPU/DP0/PC/pcnext
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/RF/register
...
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/temphalt
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/ifid_temp_flush_enable
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/pcif_enable_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/outport_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/wdat_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/idex_temp_flush_enable
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/dwen_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/rwen_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/inst_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/wsel_temp
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/stall
add wave -noupdate -expand -group DP0 /system_tb/DUT/CPU/DP0/temp_rdat2
...
add wave -noupdate -expand -group CM0 -group Dcache -expand /system_tb/DUT/CPU/CM0/DCACHE/cacheOne
...
add wave -noupdate -expand -group CM0 -group Dcache /system_tb/DUT/CPU/CM0/DCACHE/dirtyData
...
WaveRestoreCursors {{Cursor 1} {74885 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1261521 ps}
